...
namespace Academy.HoloToolkit.Unity
{
    ...
    public partial class GazeManager : Singleton<GazeManager>
    {
        ...
        private GUIText debugPanel;

        private void Start()
        {
            debugPanel = GameObject.Find("debug_group").GetComponentInChildren<GUIText>();
        }
        ...
        {
            debugPanel.text = Position.ToString();
            Debug.Log(string.Format("Gaze position: {0}", Position));
        }
        /// <summary>
